...
{
	super::InitWindow("E06_Lerp - Schweigardt"); // Window Name
...
void AppClass::InitVariables(void)
{
	...
	//Initialize m_nObjects to a random number
	srand(time(NULL));
	...
	//Initialize m_pShere and m_pMatrix to a new set of variables using m_nObjects
	...
	for (int i = 0; i < m_nObjects; i++) {
		...
		m_pMatrix[i] = glm::translate(m_pMatrix[i], glm::lerp(v3Start, v3End, fPercent));
	}
}
